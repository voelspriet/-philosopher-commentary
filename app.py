...
Respond as {philosopher['name']} using your core philosophy. Structure exactly as:

STANCE: [Bold philosophical position on this news]
REASONING: [Why you think this, connecting to your key concepts: {', '.join(philosopher['key_concepts'])}]  
RELEVANCE: [What this means for 2025 society]
INSIGHTS: [Three specific observations about the deeper implications]
CONCLUSION: [Provocative final thought that challenges assumptions]

Write authentically in your voice. Avoid generic commentary."""
